            ...
            <div className='flex flex-col md:flex-row md:justify-around md:items-start text-right py-10 text-white gap-8 px-6 md:px-12'>
                ...
                <div className='md:w-1/3 w-full'>
                    ...
                    <div className='flex justify-center md:justify-end mt-3 items-center gap-2'>
                        <Link to="/requeststechnical" className='text-lg md:text-xl font-semibold hover:underline'>
                           All Requests
                        </Link>
                    ...
                    <div className='flex justify-center md:justify-end mt-3 items-center gap-2'>
                        <Link to="/requestspending" className='text-lg md:text-xl font-semibold hover:underline'>
                            Requests pending
                        </Link>
                        <LiaHandPointLeftSolid className='text-xl' />
                    </div>
                    ...
                    <div className='flex justify-center md:justify-end mt-3 items-center gap-2'>
                        <Link to="/requestssorted" className='text-lg md:text-xl font-semibold hover:underline'>
                            Requests Sorted
                        </Link>
                        <LiaHandPointLeftSolid className='text-xl' />
                    </div>
