            ...
            selectedService && selectedService.id === service.id ? (
              ...
              >
                <img
                  ...
                  alt={service.name}
                  className="mt-4 w-full h-[200px] filter brightness-50 saturate-200 hue-rotate-180"
                />
                <div className="p-5 bg-gray-200 h-[180px] flex flex-col justify-between">
                  <div>
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-blue-800">
                      {service.name}
                    </h5>
